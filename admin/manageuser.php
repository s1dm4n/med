                      ...
                      <?php 
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <a href="index.php?page=edituser&user_id=<?php echo $row['user_id'] ?>" class="btn btn-sm btn-primary">Изменить</a>
                             <a href="javascript:void(0)" class="btn btn-sm btn-danger">Удалить</a>
                          </td>
                        </tr>
                        <?php
                        }
